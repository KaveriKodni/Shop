...
SECRET_KEY = 'django-insecure-4zp%bq2h=gpa^-_$@a2y()^#eu3(k+^$h(ppwt=#&u-iuo(c!i'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'dummyforwork125@gmail.com'
EMAIL_HOST_PASSWORD = 'Dummy@125'  # Consider using environment variables for security
